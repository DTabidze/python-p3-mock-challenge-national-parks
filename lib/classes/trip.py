...
class Trip:
    ...
    def __init__(self, visitor, national_park, start_date, end_date):
        ...
        # Visitor.trips(visitor, self)
        # NationalPark.trips(national_park, self)
        
        # Visitor.national_parks(visitor, self.national_park)
        # NationalPark.visitors(national_park, self.visitor)
